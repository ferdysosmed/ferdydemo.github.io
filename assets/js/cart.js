...
<head>
  ...
  <!-- BLOK <STYLE> LAMA SUDAH DIHAPUS DARI SINI -->
</head>
<body>
  <!-- 
    Menggunakan class .cart-container baru dari style.css
    bukan .container biasa, agar styling keranjang tetap rapi 
  -->
  <div class="cart-container">
    ...
    <div id="empty-cart-info" style="display: none;">
  ...
  <script>
    ...
    function updateCartDisplay() {
      ...
      const emptyCartEl = document.getElementById("empty-cart-info");
